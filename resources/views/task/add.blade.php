<x-app-layout>
    ...
    <div class="flex justify-center">
    <form action="{{url('/task/add')}}" method="post" class="w-full max-w-xs">
        <div class="mb-4">
            <label for="tname" class="block text-gray-700 text-sm font-bold mb-2">Task Name:</label>
            @csrf
            <input type="text" name="tname" id="tname" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        </div>
